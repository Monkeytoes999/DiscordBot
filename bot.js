...
var allowOwo = true;
var allowCuss = false;
var notCusses = ['ASSU', 'ASSE', 'ASSA', 'ASSI', 'ASSO', 'ASSY', 'ASSM', 'TITLE', 'CUMULATIVE', 'SEXY', 'SEXISM', 'TITAN','TITUS','DRAPE','ARSENAL'];
	...
	if (true){
		...
		if ((day != prevDay && scDay != 'oof') || message == "gcd.gcd.gcd...gcD."){
			...
			if(scDay.toUpperCase() != 'NONE'){
				let scAnnounce = 0;
				let scAnnArr = ['458809225120972800','486985623161274378','336507246227881984','393586279964475393','399366382799814656','156126755646734336','120545011392577537','250331063337877504', '193104123506196481', '487285707635818498'];
				let scAnnMArr = ['jon', 'bert', 'cy', 'g', 'er', 'miro', 'civ', 'voosh', 'simon', 'jake'];
				let scOof = 0;
	...
	if (!(bot.users[userID].bot)){
		...
		switch(cmd) {
			...
			case 'announce':
				if (userID == gID){
					let acAnnounce = 0;
					let acAnnArr = ['458809225120972800','486985623161274378','336507246227881984','393586279964475393','399366382799814656','156126755646734336','120545011392577537','250331063337877504', '193104123506196481', '487285707635818498'];
					let acOof = 0;
